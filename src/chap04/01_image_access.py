...
def pixel_access1(image):
    ...
    for i in range(image.shape[0]):
        for j in range(image.shape[1]):            #이중 반복을 통한 행렬 반복
            pixel = image[i, j]
